        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { 
                    Title = "JwtAuth", 
                    Version = "v1" ,
                    Description="Authentication & Authorization - ASP .NET Core 5.0 - JWT & Swagger"
                });
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme()
                {
                    ...
                    Description = "'Bearer' seçimi yapýn, ardýndan yukarýdaki boþluga aldýðýnýz token'ý girin.\r\n\r\nÖrnek: \"Bearer asdsadfjasþlfjsalhdkljasdjsakd\""
                });
